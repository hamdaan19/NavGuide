...
for i in range(0, 602):
    img_add_1 = parent_dir+'/datasets/2010_03_04_drive_0032/2010_03_04_drive_0032_Images/I1_'+str(i).zfill(6)+'.png'
    img_add_2 = parent_dir+'/datasets/2010_03_04_drive_0032/2010_03_04_drive_0032_Images/I2_'+str(i).zfill(6)+'.png'
